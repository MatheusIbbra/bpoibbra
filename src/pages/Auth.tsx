          ...
          <div className="relative z-10 flex flex-col justify-between p-12 text-sidebar-foreground">
            <div className="flex items-center gap-4">
              <img 
                src="/ibbra-logo.jpeg" 
                alt="Ibbra" 
                className="h-14 w-auto rounded-xl object-contain shadow-lg"
              />
              <div>
              ...
              <CardContent>
                <Form {...resetPasswordForm}>
                  <form onSubmit={resetPasswordForm.handleSubmit(handleResetPassword)} className="space-y-5">
                          ...
                          <FormControl>
                            <div className="relative">
                              ...
                              <Input 
                                ...
                                className="pl-11 h-12 input-executive" 
                                autoComplete="email"
                                {...field} 
                              />
                            </div>
                    ...
                    <Button 
                      type="submit" 
                      className="w-full h-12 font-semibold shadow-md hover:shadow-lg transition-all duration-200" 
                      disabled={isLoading}
                    >
                      {isLoading ? (
